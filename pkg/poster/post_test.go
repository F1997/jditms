...
func TestPostByUrls(t *testing.T) {
	...
	if err := PostByUrls(ctx, "/v1/jditms/server-heartbeat", map[string]string{"a": "aa"}); err != nil {
...
func TestPostByUrlsWithResp(t *testing.T) {
	...
	gotT, err := PostByUrlsWithResp[int64](ctx, "/v1/jditms/event-persist", map[string]string{"b": "bb"})
	if err != nil {
