...
- name: targets
    ...
    ops:
      - /resources_monitor
      - /resources_monitor/host
      - /resources_monitor/database
      - /resources_monitor/middleware
      - /resources_monitor/router
      - /resources_monitor/firewall
      - /resources_monitor/switch
